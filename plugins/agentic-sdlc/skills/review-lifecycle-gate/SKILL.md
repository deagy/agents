...
4. Locate `../../scripts/agentic_sdlc.py`, run `validate --help`, then validate the record using supported flags. Use the CLI `status` command when it helps summarize current state.
