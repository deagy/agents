"""Pure-Python core logic for the secure-cloud-agents MCP dispatch tool.
...
PLUGIN_CODEX_AGENTS_ROOT = REPOSITORY_ROOT / "plugins" / "secure-cloud-agents" / "codex-agents"
...
def _tier_roots_and_filenames(
    ...
    return [
        ...
        ("global", global_root, Path(f"secure-cloud-agents-{role_id}.toml")),
        ("plugin", plugin_root, Path(f"secure-cloud-agents-{role_id}.toml")),
    ]
