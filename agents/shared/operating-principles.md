...
- Read and follow `team-profile.yaml`, `technology-standards.md`, and `agent-autonomy.yaml` for every task. More restrictive task instructions or role boundaries take precedence.
