...
Traces to `agents/orchestration/runs/cadre-idea-7-provenance-binding-2026-07-29/
...
Covers `agents/orchestration/src/provenance.py` (the standalone hashing/git-
...
class DormantFieldTests(unittest.TestCase):
    ...
    def test_runner_capabilities_manifest_is_never_read_or_claimed(self) -> None:
        ...
        # Regression tripwire (AC-7): confirms agents/runner-capabilities.json
