"""JSON Schema validation tests for `agents/catalog.yaml` and
...
This module tests `agents/orchestration/src/schema_validate.py` -- a third,
...
ROUTING_PATH = REPOSITORY_ROOT / "agents" / "orchestration" / "routing.yaml"
CATALOG_SCHEMA_PATH = REPOSITORY_ROOT / "agents" / "catalog.schema.json"
ROUTING_SCHEMA_PATH = REPOSITORY_ROOT / "agents" / "orchestration" / "routing.schema.json"
