...
Verifies that every agents/catalog.yaml agent is reachable from
agents/orchestration/routing.yaml (routes, risk_rules, team_recipes,
...
catalog.yaml. See agents/orchestration/src/routing_health.py for the
