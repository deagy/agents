...
`agents/orchestration/runs/cadre-idea-7-provenance-binding-2026-07-29/requirements.md`:
...
Nothing here reads `agents/runner-capabilities.json` (idea #8) or resolves
